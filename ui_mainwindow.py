...
################################################################################
## Form generated from reading UI file 'mainwindowhrxSMz.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.pb_updateConf, 8, 3, 1, 1)

        self.lr_pwm = QLineEdit(self.centralwidget)
        self.lr_pwm.setObjectName(u"lr_pwm")
        self.lr_pwm.setFont(font)
        ...
        self.lr_zeroShift.setFont(font)
        ...
        self.gridLayout_2.addWidget(self.pb_saveConf, 8, 4, 1, 1)
        ...
        self.lr_step = QLineEdit(self.centralwidget)
        self.lr_step.setObjectName(u"lr_step")
        self.lr_step.setFont(font)
        self.lr_step.setReadOnly(True)

        self.gridLayout_2.addWidget(self.lr_step, 7, 1, 1, 2)

        self.le_paD = QLineEdit(self.centralwidget)
        self.le_paD.setObjectName(u"le_paD")
        self.le_paD.setFont(font)
        ...
        self.le_step = QLineEdit(self.centralwidget)
        self.le_step.setObjectName(u"le_step")
        self.le_step.setFont(font)

        self.gridLayout_2.addWidget(self.le_step, 7, 3, 1, 2)

        self.pb_readConf = QPushButton(self.centralwidget)
        self.pb_readConf.setObjectName(u"pb_readConf")

        self.gridLayout_2.addWidget(self.pb_readConf, 8, 1, 1, 1)
